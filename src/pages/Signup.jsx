          ...
          <div className="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              ...
              <input
                ...
                required
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-figma-border bg-figma-elevated placeholder-figma-text-placeholder text-white focus:outline-none focus:ring-figma-accent focus:border-figma-accent focus:z-10 sm:text-sm"
